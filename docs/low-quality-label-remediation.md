...
|---:|---|---:|---:|---|
| 1 | `知识点@语法词法@动词@实义动词@及物动词` | 33/500 | 6.6% | 已完成 500 条分诊与网页 GPT 直审；等待 7 条老师边界裁决，保持 hold |
...
| 6 | `知识点@语法词法@动词时态@过去进行时@过去进行时的肯否疑` | 74/500 | 14.8% | 已完成网页 GPT 500 条直审：DS false 大量被保留；转入“判别器边界/释义表达”小批校准，保持 hold |
...
2. 及物动词：已完成 500 条分诊和两轮网页 GPT 证据；等待 7 条老师边界裁决，期间保持 hold；
3. 过去进行时的肯否疑：先取得 1 条老师裁决，再完成 36 条 route 分层盲审与 DS 释义表达对照；
4. 其余 P0：严格按第 3.1 节的原始匹配率顺序准备明细、定义和最小诊断实验；同类标签可共用实验骨架，但不得合并结论；
5. 混合词性 M1：已具备盲审包，作为 P1 并行诊断，禁止全量；
6. 介词辨析 P2 与音/形/义填空族 P1：在对应 P0 诊断不受阻时，再做 route / prompt 对照并逐标签验收。
