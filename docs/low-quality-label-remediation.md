...
| 3 | `知识点@语篇主题@人与社会@互联通讯` | 53/500 | 已诊断-hold | 强信号：电话/邮箱/电视/网站等关键词被误作“网络社交或信息传递”主题；大量阅读父题不是该主题 | **Theme-1**：403 条 remove 中分层构造 tree 纠错 60 条小包（第 9.3 节） | 仅输出 `relabel_candidate` / `uncovered`，再按候选叶子复核 |
